...
<nav>
  ...
  <a href="#inscribirse" class="nav-cta-small">Quiero mi bonus</a>
</nav>
...
<section class="course-hero">
  <div class="hero-left">
    ...
    <div class="hero-actions">
      <a href="#inscribirse" class="btn-enroll" style="background:#f5c842; color:var(--teal-deep)">
        Agendar mi sesión
  ...
  <div class="hero-right">
    <div class="sticky-card">
      ...
      <div class="sticky-body">
        ...
        <a href="#inscribirse" class="sticky-btn" style="background:#f5c842; color:var(--teal-deep)">Agendar mi sesión 1 on 1</a>
...
<section class="bottom-cta" id="cta-final">
  <div class="bottom-cta-content reveal">
    ...
    <div class="bottom-cta-actions">
      <a href="index.php#cursos" class="btn-enroll" style="background:#f5c842; color:var(--teal-deep)">
