...
<nav id="navbar">
  ...
  <div class="nav-inner-pill">
    <ul class="nav-links">
      ...
      <li><a href="https://constructiva.edu.do/">Constructiva Experience</a></li>
...
<section class="hero" id="home">
  ...
  <div class="hero-content">
    ...
    <div class="hero-actions">
      <a href="/programa" class="btn-primary">
  ...
  <div class="hero-countdown" id="heroCountdownWrap">
    ...
    <p class="countdown-date" id="cdDate">27 MAR · 6:00 PM</p>
...
<section class="courses" id="cursos">
  ...
  <div class="courses-grid">
    <a href="/cursos/revit" class="course-tile reveal">
      <div class="tile-thumb"><div class="tile-thumb-bg" style="background:linear-gradient(135deg,#0d4a46,#12796e)"><img src="Img/Revi.png" alt="" width="200"></div><span class="tile-badge">⚡ Workshop 1</span><span class="tile-level">Intermedio</span></div>
    ...
    <a href="/cursos/ms-project" class="course-tile reveal">
      <div class="tile-thumb"><div class="tile-thumb-bg" style="background:linear-gradient(135deg,#0a2a4a,#0d6aad)"><img src="Img/Project.png" alt="" width="200"></div><span class="tile-badge">📌 Workshop 2</span><span class="tile-level">Intermedio</span></div>
    ...
    <a href="/cursos/ia" class="course-tile reveal">
      <div class="tile-thumb"><div class="tile-thumb-bg" style="background:linear-gradient(135deg,#2a1a0a,#8f5a0d)"><img src="Img/IA.png" alt="" width="200"></div><span class="tile-badge">🔥 Workshop 3</span><span class="tile-level">Todos los niveles</span></div>
    ...
    <a href="/cursos/marca" class="course-tile reveal">
      <div class="tile-thumb"><div class="tile-thumb-bg" style="background:linear-gradient(135deg,#2a1a3e,#5c2e8f)"><img src="Img/Marcap.png" alt="" width="200"></div><span class="tile-badge">✨ Workshop 4</span><span class="tile-level">Todos los niveles</span></div>
    ...
    <a href="/cursos/neuro" class="course-tile reveal">
      <div class="tile-thumb"><div class="tile-thumb-bg" style="background:linear-gradient(135deg,#1a2e1a,#2e7a3e)"><img src="Img/Neuro.png" alt="" width="200"></div><span class="tile-badge">🎯 Workshop 5</span><span class="tile-level">Todos los niveles</span></div>
...
<section class="cta-section">
  <div class="cta-inner reveal">
    ...
    <div class="cta-actions">
      <a href="#cursos" class="btn-primary">Inscribirme ahora <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
...
<script>
(function () {
  var target = new Date('2026-03-27T22:00:00Z');
