...
<!-- NAV -->
<nav>
  <a href="index.php"><img src="Img/Logo aqua.png" alt="" width="150" height="auto"></a>
...
<section class="bottom-cta" id="inscribirse">
  <div class="bottom-cta-content reveal">
    ...
    <div class="bottom-cta-actions">
      <a href="https://constructiva.edu.do#formulario" class="btn-enroll">
        Inscribirme ahora
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
      </a>
...
<!-- FOOTER -->
<footer>
  <a href="index.php" class="footer-logo-sm"><img src="Img/Logo aqua.png" alt="" width="150" height="auto"><span>.</span></a>
